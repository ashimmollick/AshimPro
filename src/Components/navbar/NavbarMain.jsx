...
const NavbarMain = () => {
  ...
  return (
    <nav className="max-w-[1300px] max-auto px-4 fixed w-full left-[50%] -translate-x-[50%] z-20 flex gap-4 mt-2">
      ...
      <div className="flex lg:hidden sm:block p-6 bg-black items-center justify-center rounded-full  border-orange border-[0.5px] ">
        <button className="text-2xl p-3 boder border-orange rounded-full text-white " onClick={toggleMenu}>
          <GiHamburgerMenu />
        </button>
      </div>
    </nav>
