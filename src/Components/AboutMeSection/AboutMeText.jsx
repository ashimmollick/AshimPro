...
const AboutMeText = () => {
  return (
    <div className="flext flex-col md:items-start sm:items-center md:text-left sm:text-center">
      ...
      <button className="border border-orange rounded-full py-2 px-4 text-lg flex items-center mt-10 hover:bg-orange hover:text-cyan transition-all duration-500 cursor-pointer md:self-start sm:self-center text-white ">My Project</button>
    </div>
  );
};
